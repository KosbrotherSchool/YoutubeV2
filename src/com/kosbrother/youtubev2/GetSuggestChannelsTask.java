...
//    protected int mRequestCode;
    ...
    GetSuggestChannelsTask(MainActivity activity, String email, String scope) {
...
//        String token = fetchToken();
    	...
    	String token = null;
    	 ...
    	 try {
             ...
             mActivity.startActivityForResult(userRecoverableException.getIntent(), MainActivity.REQUEST_CODE_RECOVER_FROM_AUTH_ERROR);
